...
def generate(which, action="gen"):
    from telethon_generator.generators import clean_tlobjects, generate_docs, generate_errors, generate_tlobjects
    from telethon_generator.parsers import find_layer, parse_errors, parse_methods, parse_tl
    ...
    tlobjects = list(itertools.chain(*(parse_tl(file, layer, methods) for file in TLOBJECT_IN_TLS)))
